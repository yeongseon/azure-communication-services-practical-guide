...
content_sources:
  diagrams:
    - id: javascript-tutorial-send-sms-flow
      type: flowchart
...
<!-- diagram-id: javascript-tutorial-send-sms-flow -->
```mermaid
flowchart TD
    START["Send SMS"]
    N1["1. Prerequisites"]
    N2["2. SmsClient Setup"]
    N3["3. Send a Single SMS"]
    N4["4. Send to Multiple Recipients"]
    N5["5. Delivery Report Handling"]
    N6["6. Error Handling Patterns"]
