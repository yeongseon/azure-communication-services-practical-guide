...
content_sources:
  diagrams:
    - id: javascript-tutorial-infrastructure-as-code-flow
      type: flowchart
...
<!-- diagram-id: javascript-tutorial-infrastructure-as-code-flow -->
```mermaid
flowchart TD
    START["Infrastructure as Code"]
    N1["1. Bicep Template for ACS Resource"]
    N2["2. Node.js Deployment Script"]
...
- [JavaScript Recipes](../recipes/index.md)
