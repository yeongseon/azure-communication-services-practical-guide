...
content_validation:
  ...
  reviewer: agent
  core_claims:
    - claim: "ACS SMS supports inbound and outbound messaging scenarios, which is why SMS operational playbooks must account for user replies and carrier-driven state changes"
