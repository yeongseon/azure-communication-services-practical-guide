...
content_sources:
  diagrams:
    - id: acs-architecture-overview
      type: flowchart
      source: mslearn
      mslearn_url: https://learn.microsoft.com/azure/communication-services/concepts/architecture
...
content_validation:
  ...
  core_claims:
    - claim: "ACS supports managed identity for authentication"
      source: https://learn.microsoft.com/azure/communication-services/concepts/authentication
      verified: true
