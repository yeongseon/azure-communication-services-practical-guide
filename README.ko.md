...
| 섹션 | 설명 | 상태 |
|---|---|---|
| [시작하기](https://yeongseon.github.io/azure-communication-services-practical-guide/) | 개요, 학습 경로, 저장소 맵 및 가이드 사용법 | 종합 |
| [플랫폼](https://yeongseon.github.io/azure-communication-services-practical-guide/platform/) | ACS의 작동 방식, 리소스 유형, 메시징 채널, 네트워킹, 인증, 이벤트 및 보안 | 종합 |
| [베스트 프랙티스](https://yeongseon.github.io/azure-communication-services-practical-guide/best-practices/) | 프로덕션 기준선, 보안, 네트워킹, 안정성, 스케일링, 비용 및 안티패턴 | 종합 |
| [SDK 가이드](https://yeongseon.github.io/azure-communication-services-practical-guide/sdk-guides/) | Python, JavaScript, Java 및 .NET용 단계별 튜토리얼과 레시피 | 종합 |
| [운영](https://yeongseon.github.io/azure-communication-services-practical-guide/operations/) | 프로비저닝, 모니터링, 배포, 상태 복구, 보안 및 비용 최적화 | 종합 |
| [트러블슈팅](https://yeongseon.github.io/azure-communication-services-practical-guide/troubleshooting/) | 의사 결정 트리, 증거 맵, 초기 10분 점검, 플레이북, 방법론 및 KQL 팩 | 종합 |
| [참조](https://yeongseon.github.io/azure-communication-services-practical-guide/reference/) | CLI 치트시트, 플랫폼 제한, KQL 쿼리 및 SDK 참조 | 종합 |
| [시각화](https://yeongseon.github.io/azure-communication-services-practical-guide/visualization/) | 지식 그래프, 트러블슈팅 맵 및 학습 경로 시각화 | 게시됨 |
| [메타](https://yeongseon.github.io/azure-communication-services-practical-guide/meta/taxonomy/) | 저장소 분류 및 콘텐츠 모델 | 게시됨 |
